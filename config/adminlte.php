...
return [
    ...
    */
    ...
    'menu' => [
        ...
        [
            'text' => 'Alimentos',
            'route'  => 'admin.alimentos.index',
            'icon'    => 'fas fa-utensils fa-fw ',
            'active' => ['admin/alimentos*'],
            'can' => 'admin.alimentos.index'
        ...
        [
            'text' => 'Especiales',
            'route'  => 'admin.especiales.index',
            'icon' => 'fas fa-bullhorn fa-fw',
            'active' => ['admin/especiales*'],
